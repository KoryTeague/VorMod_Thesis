...
In this chapter I evaluate the effectiveness of the sDEP (\Cref{sec:dep}) and GA (\Cref{sec:ga}) approaches as approximations of the two-stage stochastic optimization program presented in \Cref{sec:stochopt}.  I will 

\change{Do this}%
\textit{Write a lede for this chapter.  Detail the type of simulations performed in this chapter (the conference paper and cases I and II).}
