...
This thesis has considered the problem of resource allocation in the context of virtualized wireless networks.  It presented virtualization in \Cref{ch:intro} as a necessity of the expanding requirements of cellular networks, described a virtualization architecture as an extension of the Networks without Borders paradigm, and established the problem of resource allocation as a primary task of the virtual network builder of this architecture.  It then defined a system model and the VNB's problem of resource allocation and the dynamic slicing as a two-stage stochastic optimization problem in \Cref{ch:vnbmodel}.

In this chapter I conclude my work described in this thesis.  I desc
