...
There is a direct correlation between the number of BSs in the VWN and its capability for satisfying demand.  As the cost increases for a given solution, the average demand satisfaction trends towards 100\%.  This trend for the sDEP and the GA is depicted in \Cref{fig:Prelim_VOSDemandSatisfaction} and \Cref{tab:Prelim_DemandSatisfaction}.
...
\begin{table}[htp]
\centering
\caption{Demand Satisfaction Results for Various sDEP- and the GA-Constructed VWNs for Preliminary Simulations}
\begin{tabular}{|c|c|} 
\hline
\textbf{Number of Selected BSs; sDEP} & \textbf{Demand Satisfaction} \\
\hline
0 & 0.00\% \\
\hline
7 & 78.1\% \\
...
\hline
\hline
\textbf{Number of Solutions, BSs; GA} & \textbf{Demand Satisfaction} \\
\hline
1, 13-BS & 99.99\% \\
\hline
1, 14-BS & 99.99\% \\
...
\begin{figure}[ht]
	\centering
	\includegraphics[height=0.45\textheight]{Figures/Prelim_ComparisonSatisfactionEval}
