...
The trade off for the GA's improved run time is that the solution provided is expected to be less optimal than the sDEP, as indicated by an increased cost for the VWN and/or a decreased demand satisfaction compared to the sDEP.  \Cref{fig:Prelim_VWNCompCost} compares the cost of the sDEP as $\alpha$ increases with the cost of the various GA solutions.  

On average, the GA incurs a 36\% increased cost for the VWN, a significant amount of incurred error.

\begin{figure}[ht]
	\centering
	\includegraphics[height=0.45\textheight]{Figures/Prelim_O25sDEPGACostComparison_Expanded}
