...
IP traffic is increasing across all types of network archetypes.  According to Cisco, global IP traffic will increase nearly threefold over the 2016-2021 time period, reaching 3.34 Zetabytes (ZB) annually in 2021 from 1.15 ZB annually in 2016 \cite{ciscoVNI2017}.  Traffic across the fixed internet backbone is projected to match this threefold pace, growing from 791 Exabytes (EB) to 2.25 ZB.  However, mobile data traffic is projected to have twice the growth of fixed internet over the same period, increasing almost sevenfold from 86.4 EB in 2016 to 580 EB in 2021.  By the end of 2021, 17.4\% of global IP traffic will be mobile data or internet traffic generated by handsets, notebook cards, and mobile broadband gateways, up from 7.50\% in 2016.  More broadly, traffic from wireless and mobile devices combined will reach 63\% of total IP traffic by 2021, up from 49\% in 2016.  Overall, these projections show that population data use and the number of devices attached to the networks is increasing; in 2021, global IP traffic will reach 35 GB per capita associated with 3.5 networked devices per capita, up from 13 GB per capita and 2.3 networked devices per capita in 2016.

According to Cisco, \textit{talk about what this increase means; what is the cause and the origin of this change.  What is this increased demand being used for?}

\textit{Talk about how this increased demand will be handled - 5G - and the various technologies within.  Move towards discussing virtualization.  5G just got it's second main specification this week.  Read into those?}
