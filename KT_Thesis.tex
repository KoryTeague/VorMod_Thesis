...
\textit{1421931 - Shared Networks: Making Wireless Communication Affordable (2005) - Network sharing has been used as a expenditure saving measure going back to 2G and 3G networks.  It was typically viewed within the industry as a CAPEX saving measure.  However, it also allows for a decomposition of the network value chain ``into network operators, neutral hosts, mobile virtual network operators (MNVOs), service providers, and other entities''.  Allows for increasing specialization of products within the market.  MNNOs are capable of targeting specific classes of users, such as ``students, road wariors, tradespeople, executives, and so on.'' ``Network operation and maintenance and service creation and development are quite obviously very different businesses, and network sharing provides an efficient, manageable means for them to operate with greater independence of each other.''}
