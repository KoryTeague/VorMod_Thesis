...
This concept of virtualization partitions the classical wireless networking value chain, allowing for specialization of segments of the value chain into new entities such as resource providers and service providers \cite{1421931}.  Within the classical mobile network value chain (Figure \ref{fig:ClassicNetworkValueChain}) Doyle \textit{et al.} \cite{6737248} investigates the value chain with this segmentation in mind, and introduces the Networks without Borders (NwoB) paradigm as a new market based around constructing VWNs using pools of virtual resources.

\begin{figure}
	\centering
%	\includegraphics[width=.45\textwidth]{ClassicNetworkValueChain}
%	\includegraphics[width=\linewidth]{ClassicNetworkValueChain_1.png}
