...
\improvement{Bridge from resource sharing to virtualization.  Maybe mention how this impacts the value chain for cellular networks.}
...
\subsection{Virtualization and the Network Value Chain} \label{valuechain}
...
\improvement{Discuss the previously existing literature that I have been reading with regards to optimization methods.  Discuss optimization and stochastic optimization.  Discuss metaheuristic algorithms, especially genetic algorithms, and how they have been used for and to simplify optimization.}
