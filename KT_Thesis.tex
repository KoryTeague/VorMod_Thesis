...
This SSLT model is used in Chapter \ref{ch:testsim} to generate SP service demand and end-user demand points while testing the approaches described in Chapter \ref{ch:approaches}.
...
I formulate the presented problem of resource selection for VWN construction as a two-stage stochastic optimization program.  I introduce $z_s,\, s \in \mathcal{S}$ as a binary decision variable defined as
