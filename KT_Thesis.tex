...
& \hspace{0.4in} \delta_{ms}^{\left( \omega \right)} \in \left[ 0,\, d_m \right],\, \forall m \in \mathcal{M},\, \forall s \in \mathcal{S},\, \omega \in \Omega \label{eq:sDEPC4}
\end{align}
\end{tcolorbox}
