...
\Cref{fig:CaseI_GAComparisonCostSat} shows the level of demand satisfaction for the set of scenarios in $\hat{\Omega}$.  The demand satisfaction for the additional evaluation set of scenarios not in $\hat{\Omega}$ is identical to the demand satisfaction of $\hat{\Omega}$.  Demand satisfaction increases near linearly with the number of BSs.  Demand satisfaction is less than 100\% for solutions selecting 7, 8, and 9 BSs ($\beta \in \left\{ 0.5,\, 0.6,\, 0.7 \right\}$; first category solutions).  For solutions selecting 10 or more BSs ($\beta \geq 0.8$; second and third category solutions), demand satisfaction reaches 100\%.
...
The differences between the first and second categories of solutions is indicative of their satisfied halting condition.  The first halted with the fitness halting condition, indicating that the GA was able to create a solution that was neither overcoverage nor overcapacity, and therefore could be expected to provide 100\% demand satisfaction for the demand considered (i.e., $\beta \cdot \lambda_n$).  Solutions that are neither overcoverage nor overcapacity should provide a minimum demand satisfaction equivalent to $\beta$.  \Cref{fig:CaseI_GAScaledSatisfaction} visualizes the demand satisfaction of the various solutions relative to the demand actually seen by the GA (i.e., demand of each demand point is scaled by $\beta$ before slicing is performed by the adaptive slicing model).  As shown...\change{Continue from here\\fix figure}
...
In contrast, the second and third categories halted with the genome halting condition, indicating that the GA was unable to find a solution that was neither overcoverage nor overcapacity for the demand considered.  Solutions that are overcapacity are unable of truly targeting 100\% demand satisfaction, though by BSs sharing mutually covered points through the adaptive slicing model, it might still reach 100\% for the demand seen.  For this data set, all solutions for this category have 100\% demand satisfaction, though all of the second category ($\beta > 0.8$) overallocated resources.

\subsubsection{Comparisons and Conclusions}

With the addition of the weighting factor $\beta$, the GA is capable of being tuned to provide a number of solutions, akin to the sDEP and its weighting coefficient $\alpha$.  
