...
With the inclusion of the microcells, the VNB is capable of more nuanced constructions.  \Cref{fig:CaseII_sDEPComparisonCostCaseI} shows the cost trend of the sDEP approach for the interesting range of $\alpha \in \left[ 10,\, 20 \right]$; $\alpha = 8$ constructs a network of 0.44 cost, and $\alpha \geq 20$ constructs a network with 10 cost.  At $\alpha = 10$, the sDEP constructs a network with 9.6 cost (9 macrocells, 15 microcells) (\Cref{fig:CaseII_VoronoiDemandAllocation_sDEP_9-15}).  This cost steadily increases with additional microcells up to $\alpha = 16$ with 9.72 cost (9 macrocells, 18 microcells) (\Cref{fig:CaseII_VoronoiDemandAllocation_sDEP_9-18}).
