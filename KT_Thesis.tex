...
\begin{figure}
	...
	\caption[Interactions between roles in the VWN architecture]{\small Interactions between roles in the VWN architecture~\cite{MJ_MECOMM_17} \color{red}{\textless -- Double Check Citation!}}
...
Other work~\cite{MJ_MECOMM_17} has been completed using this architecture.%
\improvement{Describe the work and findings of this paper.  Get more papers.}
