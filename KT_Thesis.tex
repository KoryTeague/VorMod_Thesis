...
\begin{figure}[htp]
	...
	\caption[GA approach VWN cost trend for preliminary simulations]{Density-normalized histogram of constructed VWN costs of the GA approach.  Mean (13.6 BSs) shown in orange, 95\% confidence interval (13.4, 13.82) shown in dashed black.}
...
\begin{figure}[p]
	...
	\caption[Case I GA CPU run time trends]{GA CPU run time trend in further depth than \Cref{fig:CaseI_GARunTimeErrorbar} as density-normalized histograms.  For each $\beta$, means are shown in orange and 95\% confidence intervals in dashed black.}
...
\subsubsection{Improved BS Modeling}

\change{Fill out this section.\\All it takes is a sentence or two.\\Discuss the lack of complexity in BS modeling, such as interference between BSs, or the spatial correlation of BSs provided by the same RP}
