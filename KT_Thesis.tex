...
The GA approach has an improved run time trend compared to the sDEP.  Across all three simulations, the GA approach converged to a solution in far less CPU time than the sDEP approach; due to this, the GA exhibits a significant speedup ratio relative to the sDEP, as shown in \Cref{tab:VWNConstructionRunTimes}.  
