...
This thesis uses a virtualization architecture based on the NwoB paradigm presented by Doyle et al.~\cite{6737248}.%
\improvement{Continue expanding this in the morning.}

\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{VWNArchitecture}
	\caption[\small VWN architecture as used in this work]{\small VWN architecture as used in this work~\cite{MJ_MECOMM_17} \textless -- \color{red}{Double Check Citation!}}
