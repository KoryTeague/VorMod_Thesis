...
This thesis has considered the problem of BS selection and dynamic slicing in the context of virtualized wireless networks.  In \Cref{ch:intro}, this thesis presented virtualization as a necessity of the expanding requirements of cellular networks and described a virtualization architecture as an extension of the Networks without Borders paradigm.  Then, it established the problem of resource allocation as a primary task of the virtual network builder of this architecture.

It then defined a system model and the VNB's problem of resource allocation and the dynamic slicing as a two-stage stochastic optimization problem in \Cref{ch:vnbmodel}.
