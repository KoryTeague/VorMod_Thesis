...
In this section I present the results of these preliminary simulations.  \unsure{Consider presenting run time results later; after demand satisfaction}First, run time results of the two approaches will be presented and comparisons made.  Second, the network cost results will be presented and compared, followed by, third, the network demand satisfaction results.  Finally, this section will end with my conclusions of these simulations
...
\info{See Comment}%
%If I understand what you are doing here, then this is weird. Satisfying a demand which is 80% of the original demand is not the same as satisfying 80% of the demand. The latter is more a statement about probability. Or should be.
%Namely, if the goal is to satisfy 80% of the demand, then we should be able to choose which 80%. If you just scale the demand, then we lose this choice. 
