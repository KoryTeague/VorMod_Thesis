...
This concept of virtualization partitions the classical wireless networking value chain, allowing for specialization of segments of the value chain into new entities such as resource providers and service providers~\cite{1421931}.  Doyle et al.~\cite{6737248} investigates the value chain with this segmentation in mind, and introduces the Networks without Borders (NwoB) paradigm as a new market based around constructing VWNs using pools of virtual resources.  Within the typical mobile network value chain (Figure \ref{fig:ClassicNetworkValueChain}), 

\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{ClassicNetworkValueChain}
	\caption{\small Typical MNO value chain~\cite{6737248}}
...
\begin{figure}
	...
	\caption{\small Proposed network value chain under the NwoB paradigm~\cite{6737248}}
